                ...
                <div className="bg-white shadow-xl rounded-lg overflow-hidden hover:shadow-2xl transition duration-300">
                  ...
                  <div className="p-5">
                    ...
                    <div className="mt-4 space-y-2">
                      <p className="text-gray-700 font-medium"><span className="font-bold">Type:</span> {property.type}</p>
                      <p className="text-gray-700 font-medium"><span className="font-bold">City:</span> {property.city}</p>
                      <p className="text-gray-700 font-medium"><span className="font-bold">Locality:</span> {property.locality}</p>
