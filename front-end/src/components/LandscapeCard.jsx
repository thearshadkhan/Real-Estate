  ...
  />
      ...
      <div className="flex flex-col justify-between p-2">
        ...
        <div className="flex flex-col space-y-1">
          <div className="text-xl text-gray-700 flex"><MdOutlineAttachMoney className="w-6 h-6 text-red mt-1" />
            {property.price}
          </div>
          <div className="text-xl text-gray-700 flex"><BiArea className="w-5 h-5 text-red mt-1" />
            {property.size} sq ft
          </div>
        ...
        <button className="px-4 py-2 w-fit self-center bg-red-600 hover:drop-shadow-xl text-white rounded-lg flex shadow-md hover:bg-red-700 transition">
