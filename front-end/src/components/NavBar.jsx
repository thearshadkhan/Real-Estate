...
const NavBar = () => {
  return (
    ...
    <nav className='fixed top-0 w-9/10 bg-red-700 p-4 text-white flex flex-row justify-between ml-15 mt-2 z-10 rounded-full'>
      <Link to='/'><h1 className="flex text-2xl font-bold px-4 py-2 rounded-full">Brick & Beams<img src={logo} alt="Logo" className="w-7 h-7" />
      </h1></Link>
      ...
      <div className="flex gap-4 items-center">
        <Link to="/addProperty" className="px-4 py-2  rounded-full cursor-pointer hover:bg-red-900 transition">Add Property →</Link>
